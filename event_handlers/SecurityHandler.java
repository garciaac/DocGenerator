 ...
 * Last Modified: Jul 20, 2012 2:49:20 PM
 */
...
/**
 * 
 * This class dictates what will happen when the 'Security' button in the menu
 * is clicked.
 * 
 */
public class SecurityHandler extends GenericEventHandler
{
	/**
	 * Delegates functionality to parent class since no custom functionality is
	 * implemented at this time for Security.
	 * @throws IOException 
	 */
	public SecurityHandler() throws IOException
	{
		super(Directories.SECURITY);
	}
}